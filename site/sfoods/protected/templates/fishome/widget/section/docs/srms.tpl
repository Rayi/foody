...
<p><img src="/static/fishome/widget/section/docs/img/pack.gif" alt="传统资源合并方式导致性能恶化"></p>
<p>那么，在F.I.S中是如何解决这类问题的呢？答案就是：</p>
<pre><code>使用F.I.S对项目进行编译后会产生一张【资源表】，F.I.S的前端或后端框架利用这张表实现对静态资源的管理与优化。</code></pre>
<p><img src="/static/fishome/widget/section/docs/img/map.png" alt="F.I.S的静态资源管理示意图"></p>
